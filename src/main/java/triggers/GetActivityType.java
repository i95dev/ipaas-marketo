...
public class GetActivityType implements Function {
	private static final Logger logger=LoggerFactory.getLogger(GetActivityType.class);
	...
	public void execute(ExecutionParameters parameters) {
		...
		final String endpoint ="/rest/v1/activities/external/types.json";
		 try {
