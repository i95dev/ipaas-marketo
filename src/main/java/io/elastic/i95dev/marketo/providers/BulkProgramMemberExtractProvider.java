...
public class BulkProgramMemberExtractProvider implements DynamicMetadataProvider {
	private static final Logger logger = LoggerFactory.getLogger(BulkProgramMemberExtractProvider.class);
	...
	public JsonObject getMetaModel(JsonObject configuration) {
		...
		String Endpoint = "/rest/v1/programs/members/describe.json";
