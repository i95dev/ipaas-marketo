...
public class GetOpportunityByName implements Function {
	private static final Logger logger=LoggerFactory.getLogger(GetOpportunityByName.class);
	...
	public void execute(ExecutionParameters parameters) {
		...
		JsonString name=configuration.getJsonString("OpportunityName");
		
		if (name == null) {
            throw new IllegalStateException(" Opportunity Name is required");
        }
		
		 final String endpoint ="/rest/v1/opportunities/schema/fields/"+name.getString()+".json";
		 try {
