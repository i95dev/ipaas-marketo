...
public class BulkLeadImport implements Function{
	...
	public void execute(ExecutionParameters parameters) {
		...
		JsonString format=configuration.getJsonString("format");
		if (format == null) {
            throw new IllegalStateException("format is required");
        }
		String endpoint="/bulk/v1/leads.json?format="+format.getString();
		...
		try {
            ...
            String statusEndpoint="/bulk/v1/leads/batch/"+batchId.getString()+".json";
            ...
            while(!sts1.equals("Completed"))  {
            	Thread.sleep(60000);
            	String statusEndpoint1="/bulk/v1/leads/batch/"+batchId.getString()+".json";
            ...
            if(fail>0){
            	...
            	String failendpoint="/bulk/v1/leads/batch/"+batchId.getString()+"/failures.json";
            ...
            if(warning>0){
            	...
            	String warningendpoint="/bulk/v1/leads/batch/"+batchId.getString()+"/warnings.json";
