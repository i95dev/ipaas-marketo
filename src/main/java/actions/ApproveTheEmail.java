...
public class ApproveTheEmail implements Function {
private static final Logger logger=LoggerFactory.getLogger(ApproveTheEmail.class);
	...
	public void execute(ExecutionParameters parameters) {
		...
		if (id == null) {
            throw new IllegalStateException(" emailId is required");
        }
		
		 final String endpoint ="/rest/asset/v1/email/"+id.getString()+"/approveDraft.json";
		 try {
